...
$(document).ready(function(){
	...
	if(get_cookie == null) // If no cookie is set apply default theme
	{
		...
		get_cookie = 'abstract-blue';
	}
	$("#active-theme-globals").attr({ href: base_url+"public/admin/themes/" + get_cookie + "/css/globals.css"});
	$("#active-theme-commons").attr({ href: base_url+"public/admin/themes/" + get_cookie + "/css/commons.css"});
	$("#active-theme-plugins").attr({ href: base_url+"public/admin/themes/" + get_cookie + "/css/plugins.css"});
