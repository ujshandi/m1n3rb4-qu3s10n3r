...
function formtowizard(options){
	// yanto
	this.setting=jQuery.extend({persistsection:false, revealfx:['slide', 500], detail:'', oninit:function(){}, onpagechangestart:function(){}}, options)
...
formtowizard.prototype={
	...
	init:function(setting){
		...
		jQuery(function($){ //on document.ready
			...
			// yanto
			var dt = setting.detail
			$('#'+dt).prepend($stepsguide)
			...
			var $paginatediv=$('<div class="formpaginate" style="overflow:hidden;"><span class="prev" style="float:left">Sebelumnya</span> <span class="status">0 data</span> <span class="next" style="float:right">Selanjutnya</span></div>')
			//var $paginatediv=$('<div class="formpaginate" style="overflow:hidden;"><span class="prev" style="float:left">Sebelumnya</span> <span class="status">Step 1 of </span> <span class="next" style="float:right">Selanjutnya</span></div>')
			
			// yanto
			var dt = setting.detail
			$('#'+dt).prepend($paginatediv)
