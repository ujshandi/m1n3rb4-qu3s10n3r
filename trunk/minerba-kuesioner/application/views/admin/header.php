...
<head>
    ...
    <meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;" />
        ...
        <title>Pusdiklat Minerba</title>

        <!-- Link shortcut icon-->
        <link rel="shortcut icon" type="image/ico" href="<?php echo base_url(); ?>public/admin/images/favicon2.ico" /> 

        <!-- Link css-->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/admin/css/zice.style.css" />

    
        <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="components/flot/excanvas.min.js"></script><![endif]-->  
    
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/js/jquery.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/ui/jquery.ui.min.js"></script> 
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/ui/jquery.autotab.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/ui/timepicker.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/colorpicker/js/colorpicker.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/checkboxes/iphone.check.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/elfinder/js/elfinder.full.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/spinner/ui.spinner.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/tipsy/jquery.tipsy.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/editor/jquery.cleditor.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/chosen/chosen.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/confirm/jquery.confirm.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/validationEngine/jquery.validationEngine.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/validationEngine/jquery.validationEngine-en.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/vticker/jquery.vticker-min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/sourcerer/sourcerer.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/fullcalendar/fullcalendar.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/flot/flot.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/flot/flot.pie.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/flot/flot.resize.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/flot/graphtable.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/uploadify/swfobject.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/uploadify/uploadify.js"></script>        
        <script type="text/javascript" src="<?php echo base_url(); ?>public/admin/components/checkboxes/customInput.jquery.js"></script>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head>        
    ...
    <!-- Header -->
        <div id="header">
          ...
          <div class="setting"><b>Welcome,</b> <b class="red">Arief Eka Putra</b><img src="<?php echo base_url(); ?>public/admin/images/gear.png" class="gear" alt="Profile Setting" />
                        <ul class="subnav ">
